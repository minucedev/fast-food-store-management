...
public class Statistic_GUI extends javax.swing.JPanel {
   ...
   public void pieChart(String month) {
       ...
       roundPanel14.add(customerChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 210, 220));
       soldProductChart = new GUI.PieChart(spL,"");
       roundPanel14.add(soldProductChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 210, 220));
    ...
    private void initComponents() {
        ...
        jPanel1.add(roundPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 410, -1, -1));
        ...
        roundPanel14.add(WarningC, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 190, 90));

        WarningS.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        WarningS.setText("Không có thống kê tháng này");
        roundPanel14.add(WarningS, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 60, 190, 90));
